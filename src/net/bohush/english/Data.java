...
public class Data {
	static private String[] data = {
			...
			"Health\n"
			 ...
			 + "Patient:	Sure.\n"
			 + "Nurse:	Well, your temperature is a little high,\n"
			 ...
			 + "Patient:	Yes.\n"
			 + "Doctor:	Take a deep breath. It doesn't seem to be anything serious.\n"
			 + "	You probably just have the flu. There's a virus going around.\n"
			 + "	Don't worry about it.\n"
			 + "Patient:	So, there's nothing I can do?\n"
			 + "Doctor:	Go home, rest and drink lots of fluids.\n"
			...
			"Banking\n"
			 ...
			 + "Clerk:	Well, there are two options.\n"
			 ...
			 + "Clerk:	Our golden checking account has a minimum balance requirement\n"
			 + "	of one thousand dollars, but there's no monthly service fee.\n"
			 + "	Money orders and traveler's checks are free as well.\n"
			 + "Mario:	Which choice would you prefer?\n"
			 + "Laura:	A ten dollar service fee is a lot of money,\n"
			...
			"Shopping for food\n"
			 ...
			 + "Kathy:	Look who's talking.\n"
			 + "	With your usual diet of meat and potatoes, you're a real health nut.\n"
			...
			"Looking for an apartment\n"
			 ...
			 + "Lady:	It has one bedroom, a living area, a kitchen, and a small den.\n"
			 ...
			 + "Lady:	His company offered him a job in New York.\n"
			 + "	He moved to the east coast last month.\n"
			...
			"Moving to another city\n"
			 ...
			 + "Ana:	Nice to meet you. I'm still somewhat unfamiliar with this area.\n"
			 ...
			 + "Jim:	Oh really? I came here from Chicago ten years ago.\n"
			 + "	How do you like the west coast so far?\n"
			 + "Ana:	A lot. I always wanted to live in Portland. So I took a chance and here I am.\n"
			 + "Jim:	Yes. It's beautiful here.\n"
			 + "	Well listen, if there's anything I can do for you, just call.\n"
			 + "Ana:	OK, thanks!	\n",
			...
			"Looking for a job\n"
			 ...
			 + "Susan:	Thank you. 	\n"
			 + "Director:	After you finished school you went to work for an insurance company.\n"
			 + "	What were your duties there?\n"
			 + "Susan:	At first I assisted the vice president of corporate sales.\n"
			 + "	I did most of his legwork for him\n"
			 + "	and took care of all the administrative duties.\n"
			 ...
			 + "Susan:	 	The position you advertised offers me\n"
			 + "	the opportunityto move into a managerial position.\n"
			 + "	I believe this is the right step at this point in my career.\n"
			 + "Director:	I see. You're a very interesting candidate.\n"
			...
			"The holiday season\n"
			 ...
			 + "	And except for the sweater I want to give my husband,\n"
			 + "	I even have all my gifts.\n"
			 ...
			 + "Ingrid:	Of course. Without a Christmas tree, Christmas carols, cookies,\n"
			 + "	and presents under the tree, Christmas just isn't the same for me.\n"
			 + "Bob:	But I don't have any presents to give you.\n"
			 + "Ingrid:	Well, you still have time to shop until the twenty fifth.\n"
			 + "	I'm just kidding. Presents or no presents, we'd love to have you. \n"
			...
			"Traveling\n"
			 ...
			 + "Monica:	I have a week off next month.\n"
			 + "	My husband and I are going to the Caribbean for seven days.\n"
			 + "Jane:	That sounds exciting! I heard they have beautiful beaches over there.\n"
			 + "	Where exactly are you planning to go?\n"
			 + "Monica:	First, we'll fly to Puerto Rico.\n"
			 + "	Then, we'll go to Barbados, Aruba, and Jamaica.\n"
			...
			"Hobbies\n"
			 ...
			 + "John:	But you do all this gardening. With a lot of success, by the way.\n"
			 + "	Your roses are beautiful this year. \n"
			 + "Louise:	Thanks. I enjoy working in the garden so much,\n"
			 + "	it doesn't even feel like exercise. \n"
			 + "John:	How's your husband?  \n"
			 + "Louise:	Fine. He started redoing the rec-room this weekend.\n"
			 + "	I hope all the hammering didn't bother you.\n"
			 + "John:	Oh, not at all. Peter and I went hiking.\n"
			...
			"American culture and television\n"
			 ...
			 + "John:	I planned to go to Vermont,\n"
			 + "	but because of the weather, we decided to stay home.\n"
			 ...
			 + "Mary:	No, my husband didn't want to.\n"
			 + "	I was really disappointed. We ended up watching a movie instead. \n"
			 ...
			 + "John:	You can't convince me to watch a horror movie.\n"
			 + "	I prefer to watch a sitcom or even a soap opera. Besides, I'd rather read.\n"
			...
			"Education\n"
			 ...
			 + "Principal:	We will do what we can to help your son make the transition\n"
			 + "	to his new school. I see he finished fifth grade as an honor student.\n"
			 + "Mother:	Yes, we're very proud of him.\n"
			 + "	We're just worried that the curriculum is so different here\n"
			 + "	that he will have trouble catching up. Can you recommend a tutor?\n"
			 + "Principal:	Sure.\n"
			 + "Mother:	We want to help him ourselves, but both my husband and I are working...\n"
			 + "Principal:	Don't worry, your son may not have any trouble catching up by himself.\n"
			...
			"Ceremonies\n"
			 ...
			 + "Peter:	Hmm.\n"
			 + "Linda:	Jealous?\n"
			 + "Peter:	No, I have no reason to be. Soon we'll get married ourselves.\n"
			...
			"Urban life\n"
			 ...
			 + "Carol:	I used to live there five years ago. I loved going to Sullivan Park.\n"
			 ...
			 + "Carol:	Really?\n"
			 + "Linda:	Yes, there's a lot of crime now:	carjackings, muggings, you name it.\n"
			...
			"Traffic\n"
			 ...
			 + "John:	And so do a lot of other people. This traffic is bumper to bumper.\n"
			 ...
			 + "Sharon:	I hope not.\n"
			 + "John:	I'm sure we'll go a little faster on the streets.\n"
			...
			"In the hotel\n"
			 ...
			 + "Manager:	I'm sorry. I don't have any other rooms available at the moment.\n"
			 ...
			 + "Manager:	Well, in the meantime, you could enjoy the complimentary breakfast\n"
			 + "	that we'll send to your room.\n"
			 + "David:	This will hardly take care of the problem, but thanks.\n"
			 + "	And make sure my shower is fixed as soon as possible.\n"
			 + "Manager:	Of course. I'll continue to look for another room for you as well.\n"
			...
			"Settling down\n"
			 ...
			 + "Tony:	Well, you're right and we're all happy for you, buddy.\n"
			...
			"Thirty\n"
			 ...
			 + "Jill:	Not me. I've been cleaning the bathroom every weekend.\n"
			 + "	I even scrubbed the bathtub really well. \n"
			 + "Sandy:	It's not my turn. I've been dusting the furniture for the last three months.\n"
			...
			"Politics and Democracy\n"
			 ...
			 + "Bob:	Really, he's too conservative for me.\n"
			 + "	I know he has gone up in the polls lately, but I think he lost the debate last night\n"
			 + "Chris:	I don't think so.\n"
			 + "	As usual, he showed that he's well informed and that he's a terrific speaker.\n"
			 + "Martha:	Besides, he has a lot of experience in Washington, D.C.\n"
			 + "	where he's very well respected.  He's a former senator.\n"
			...
			"Traveling abroad\n"
			 ...
			 + "John:	Thanks for the tip, but I'd rather wait for the post office to open.\n"
			 + "	The Federal building is all the way downtown. \n"
			...
			"The media and communications\n"
			 ...
			 + "Chris:	Well, I know the sports channel is going to televise the boxing match live.\n"
			 ...
			 + "Chris:	Although, sitcoms are OK,\n"
			 + "	I'd rather watch a sport event or music videos on MTV any day.\n"
			 + "	Give me the remote control.\n"
			 + "Lisa:	No way.\n"
			 + "Chris:	Fine. While you watch TV all by yourself,\n"
			...
			"Bargaining\n"
			 ...
			 + "Jessica:	Well, a lot more people will be stopping by later.\n"
			 ...
			 + "Jessica:	Fine. You've got yourself a deal. And come back soon.\n"
			...
			"Cultural Events\n"
			 ...
			 + "	The pumpkin pie was also fantastic, naturally, since it was made by yours truly.\n"
			...
			"Services\n"
			 ...
			 + "Mechanic:	I jump started your car and it's running fine.\n"
			 + "	But you'll need a new battery soon.\n"
			 + "Emily:	Not today. I need to get to work.\n"
			 + "Mechanic:	Suit yourself.\n"
			 + "	But if you don't get a battery soon, you'll have the same problem again.\n",

			"Music\n"
			 + "Cindy:	What a great band!\n"
			 + "Edward:	Yes. The drummer was great.\n"
			 + "Cindy:	I thought the saxophone player was outstanding.\n"
			 + "Edward:	You know, I could've been a great musician myself\n"
			...
			"Cultural diversity in the USA\n"
			 + "Beth:	Shannon told me you're sending Jessica to\n"
			 + "	an after-school Chinese language program.\n"
			 + "Wayne:	Yes, we want to make sure that she has a chance to use Chinese on a daily basis.\n"
			 + "Beth:	I think it's great that you're doing this.\n"
			 + "	There are several languages in my background, but none of them were passed on to me.\n"
			 + "Wayne:	Really? What languages?\n"
			 + "Beth:	Well, my mother's parents were English and German\n"
			 + "	and I think my father's parents were from Mexico.\n"
			 + "Wayne:	You're not sure?\n"
			 + "Beth:	No! I asked my dad where his family came from and he said he didn't really know.\n"
			 + "	In fact, I'm not even sure what his last name used to be\n"
			 + "	before his family changed it.\n"
			 + "	I know his father spoke Spanish but he wouldn't teach it to his kids\n"
			 + "	because it might inhibit their English. \n"
			 + "Wayne:	What a shame!\n"
			 + "Beth:	I think so, too. I wish I had learned another language as a child.\n"
			...
			"The Hollywood craze\n"
			 ...
			 + "Frank:	If I were you, I wouldn't believe that sensationalist trash.\n"
			 ...
			 + "Karen:	Well, the movie's coming out next week.\n"
